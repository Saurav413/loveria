...
export default function CouplePhotoPage() {
  ...
  const upload = async () => {
    ...
    const result = await api<{ error?: string }>("/api/couple-photo", {
      method: "POST",
  ...
  return (
    <main className="page-shell" style={{ maxWidth: 480, paddingTop: "3rem" }}>
      <div className="glass-card">
        <h1 style={{ color: "var(--primary)", marginTop: 0 }}>Couple Photo</h1>
        <p className="muted">Add a photo of you two — it becomes part of your cinematic backgrounds.</p>
        <input
          id="photo"
          type="file"
          accept="image/*"
        ...
        {preview && (
          ...
          <img src={preview} alt="Preview" style={{ width: "100%", maxHeight: 240, objectFit: "cover", borderRadius: 12, marginTop: 12 }} />
        )}
